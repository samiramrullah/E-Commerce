...
import deliveryvechile from '../public/icons/delivery-van.svg';
import moneyback from '../public/icons/money-back.svg';
import supportimg from '../public/icons/service-hours.svg'
const Hero = () => {
    return (
        <>
            ...
            <div class="container py-16">
                <div class="w-10/12 grid grid-cols-3 gap-6 mx-auto justify-center">
                    <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                        ...
                        <Image class="w-12 h-12 object-contain" src={deliveryvechile}></Image>
                        <div>
                    ...
                    <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                        <Image class="w-12 h-12 object-contain" src={moneyback}></Image>
                        <div>
                    ...
                    <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                        <Image class="w-12 h-12 object-contain" src={supportimg}></Image>
                        <div>
