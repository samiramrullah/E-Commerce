    ...
    return (
        <>
            <section class="flex flex-col lg:justify-end">
                <div class="w-full bg-gray-100 border-t dark:border-gray-900 dark:bg-gray-900">
                        ...
                        <div class="flex flex-wrap items-center justify-between px-4 mb-4">
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="w-full py-1 lg:w-auto lg:py-0">
                                    <a href="#" class="inline-block w-full px-5 py-4 font-medium leading-4 text-center text-gray-100 bg-blue-700 rounded-md dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-blue-600">Subscribe</a>
                                </div>
                            </div>
                        </div>
                    </div>
